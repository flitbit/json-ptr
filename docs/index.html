...
<a href="#release-bundles" id="release-bundles" style="color: inherit; text-decoration: none;">
  <h2>Release Bundles</h2>
</a>
<p>As of v3.0.0, we provide CJS, ESM, and UMD builds under the <code>dist/</code> folder when you install the package from NPM, we also have all appropriate references in our <code>package.json</code> file, so your code should just work. If you need a CDN reference to <code>json-ptr</code>, try <a href="https://unpkg.com/">UNPKG</a>, which picks up our releases automatically.</p>

<a href="#use" id="use" style="color: inherit; text-decoration: none;">
  <h2>Use</h2>
</a>
<p>Both CJS and ESM are supported.</p>
<pre><code class="language-javascript"><span class="hl-1">const</span><span class="hl-0"> { </span><span class="hl-2">JsonPointer</span><span class="hl-0"> } = </span><span class="hl-3">require</span><span class="hl-0">(</span><span class="hl-4">&#39;json-ptr&#39;</span><span class="hl-0">);</span>
</code></pre>
<pre><code class="language-javascript"><span class="hl-5">import</span><span class="hl-0"> { </span><span class="hl-6">JsonPointer</span><span class="hl-0"> } </span><span class="hl-5">from</span><span class="hl-0"> </span><span class="hl-4">&#39;json-ptr&#39;</span><span class="hl-0">;</span>
</code></pre>
...
<pre><code class="language-ts"><span class="hl-7">// examples/versions.ts</span><br/><span class="hl-5">import</span><span class="hl-0"> { </span><span class="hl-6">JsonPointer</span><span class="hl-0"> } </span><span class="hl-5">from</span><span class="hl-0"> </span><span class="hl-4">&#39;json-ptr&#39;</span><span class="hl-0">;</span><br/><br/><span class="hl-5">export</span><span class="hl-0"> </span><span class="hl-1">type</span><span class="hl-0"> </span><span class="hl-8">SupportedVersion</span><span class="hl-0"> = </span><span class="hl-4">&#39;1.0&#39;</span><span class="hl-0"> | </span><span class="hl-4">&#39;1.1&#39;</span><span class="hl-0">;</span><br/><br/><span class="hl-1">interface</span><span class="hl-0"> </span><span class="hl-8">PrimaryGuestNamePointers</span><span class="hl-0"> {</span><br/><span class="hl-0">  </span><span class="hl-6">name</span><span class="hl-0">: </span><span class="hl-8">JsonPointer</span><span class="hl-0">;</span><br/><span class="hl-0">  </span><span class="hl-6">surname</span><span class="hl-0">: </span><span class="hl-8">JsonPointer</span><span class="hl-0">;</span><br/><span class="hl-0">  </span><span class="hl-6">honorific</span><span class="hl-0">: </span><span class="hl-8">JsonPointer</span><span class="hl-0">;</span><br/><span class="hl-0">}</span><br/><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">versions</span><span class="hl-0">: </span><span class="hl-8">Record</span><span class="hl-0">&lt;</span><span class="hl-8">SupportedVersion</span><span class="hl-0">, </span><span class="hl-8">PrimaryGuestNamePointers</span><span class="hl-0">&gt; = {</span><br/><span class="hl-0">  </span><span class="hl-4">&#39;1.0&#39;</span><span class="hl-6">:</span><span class="hl-0"> {</span><br/><span class="hl-0">    </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/guests/0/name&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">    </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/guests/0/surname&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">    </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/guests/0/honorific&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">  },</span><br/><span class="hl-0">  </span><span class="hl-4">&#39;1.1&#39;</span><span class="hl-6">:</span><span class="hl-0"> {</span><br/><span class="hl-0">    </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/primary/primaryGuest/name&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">    </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/primary/primaryGuest/surname&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">    </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-6">JsonPointer</span><span class="hl-0">.</span><span class="hl-3">create</span><span class="hl-0">(</span><span class="hl-4">&#39;/primary/primaryGuest/honorific&#39;</span><span class="hl-0">),</span><br/><span class="hl-0">  },</span><br/><span class="hl-0">};</span><br/><br/><span class="hl-1">interface</span><span class="hl-0"> </span><span class="hl-8">Reservation</span><span class="hl-0"> </span><span class="hl-1">extends</span><span class="hl-0"> </span><span class="hl-8">Record</span><span class="hl-0">&lt;</span><span class="hl-8">string</span><span class="hl-0">, </span><span class="hl-8">unknown</span><span class="hl-0">&gt; {</span><br/><span class="hl-0">  </span><span class="hl-6">version</span><span class="hl-0">?: </span><span class="hl-8">SupportedVersion</span><span class="hl-0">;</span><br/><span class="hl-0">}</span><br/><br/><span class="hl-7">/**</span><br/><span class="hl-7"> * Gets the primary guest&#39;s name from the specified reservation.</span><br/><span class="hl-7"> * </span><span class="hl-1">@param</span><span class="hl-7"> </span><span class="hl-6">reservation</span><span class="hl-7"> a reservation, either version 1.0 or bearing a `version`</span><br/><span class="hl-7"> * property indicating the version.</span><br/><span class="hl-7"> */</span><br/><span class="hl-1">function</span><span class="hl-0"> </span><span class="hl-3">primaryGuestName</span><span class="hl-0">(</span><span class="hl-6">reservation</span><span class="hl-0">: </span><span class="hl-8">Reservation</span><span class="hl-0">): </span><span class="hl-8">string</span><span class="hl-0"> {</span><br/><span class="hl-0">  </span><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">pointers</span><span class="hl-0"> = </span><span class="hl-6">versions</span><span class="hl-0">[</span><span class="hl-6">reservation</span><span class="hl-0">.</span><span class="hl-6">version</span><span class="hl-0"> || </span><span class="hl-4">&#39;1.0&#39;</span><span class="hl-0">];</span><br/><span class="hl-0">  </span><span class="hl-5">if</span><span class="hl-0"> (!</span><span class="hl-6">pointers</span><span class="hl-0">) {</span><br/><span class="hl-0">    </span><span class="hl-5">throw</span><span class="hl-0"> </span><span class="hl-1">new</span><span class="hl-0"> </span><span class="hl-8">Error</span><span class="hl-0">(</span><span class="hl-4">`Unsupported reservation version: </span><span class="hl-1">${</span><span class="hl-6">reservation</span><span class="hl-9">.</span><span class="hl-6">version</span><span class="hl-1">}</span><span class="hl-4">`</span><span class="hl-0">);</span><br/><span class="hl-0">  }</span><br/><span class="hl-0">  </span><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">name</span><span class="hl-0"> = </span><span class="hl-6">pointers</span><span class="hl-0">.</span><span class="hl-6">name</span><span class="hl-0">.</span><span class="hl-3">get</span><span class="hl-0">(</span><span class="hl-6">reservation</span><span class="hl-0">) </span><span class="hl-5">as</span><span class="hl-0"> </span><span class="hl-8">string</span><span class="hl-0">;</span><br/><span class="hl-0">  </span><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">surname</span><span class="hl-0"> = </span><span class="hl-6">pointers</span><span class="hl-0">.</span><span class="hl-6">surname</span><span class="hl-0">.</span><span class="hl-3">get</span><span class="hl-0">(</span><span class="hl-6">reservation</span><span class="hl-0">) </span><span class="hl-5">as</span><span class="hl-0"> </span><span class="hl-8">string</span><span class="hl-0">;</span><br/><span class="hl-0">  </span><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">honorific</span><span class="hl-0"> = </span><span class="hl-6">pointers</span><span class="hl-0">.</span><span class="hl-6">honorific</span><span class="hl-0">.</span><span class="hl-3">get</span><span class="hl-0">(</span><span class="hl-6">reservation</span><span class="hl-0">) </span><span class="hl-5">as</span><span class="hl-0"> </span><span class="hl-8">string</span><span class="hl-0">;</span><br/><span class="hl-0">  </span><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">names</span><span class="hl-0">: </span><span class="hl-8">string</span><span class="hl-0">[] = [];</span><br/><span class="hl-0">  </span><span class="hl-5">if</span><span class="hl-0"> (</span><span class="hl-6">honorific</span><span class="hl-0">) </span><span class="hl-6">names</span><span class="hl-0">.</span><span class="hl-3">push</span><span class="hl-0">(</span><span class="hl-6">honorific</span><span class="hl-0">);</span><br/><span class="hl-0">  </span><span class="hl-5">if</span><span class="hl-0"> (</span><span class="hl-6">name</span><span class="hl-0">) </span><span class="hl-6">names</span><span class="hl-0">.</span><span class="hl-3">push</span><span class="hl-0">(</span><span class="hl-6">name</span><span class="hl-0">);</span><br/><span class="hl-0">  </span><span class="hl-5">if</span><span class="hl-0"> (</span><span class="hl-6">surname</span><span class="hl-0">) </span><span class="hl-6">names</span><span class="hl-0">.</span><span class="hl-3">push</span><span class="hl-0">(</span><span class="hl-6">surname</span><span class="hl-0">);</span><br/><span class="hl-0">  </span><span class="hl-5">return</span><span class="hl-0"> </span><span class="hl-6">names</span><span class="hl-0">.</span><span class="hl-3">join</span><span class="hl-0">(</span><span class="hl-4">&#39; &#39;</span><span class="hl-0">);</span><br/><span class="hl-0">}</span><br/><br/><span class="hl-7">// The original layout of a reservation (only the parts relevant to our example)</span><br/><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">reservationV1</span><span class="hl-0">: </span><span class="hl-8">Reservation</span><span class="hl-0"> = {</span><br/><span class="hl-0">  </span><span class="hl-6">guests:</span><span class="hl-0"> [</span><br/><span class="hl-0">    {</span><br/><span class="hl-0">      </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wilbur&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Mr.&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">    },</span><br/><span class="hl-0">    {</span><br/><span class="hl-0">      </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wanda&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Mrs.&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">    },</span><br/><span class="hl-0">    {</span><br/><span class="hl-0">      </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wilma&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Miss&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">child:</span><span class="hl-0"> </span><span class="hl-1">true</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">age:</span><span class="hl-0"> </span><span class="hl-10">12</span><span class="hl-0">,</span><br/><span class="hl-0">    },</span><br/><span class="hl-0">  ],</span><br/><span class="hl-0">  </span><span class="hl-7">// ...</span><br/><span class="hl-0">};</span><br/><br/><span class="hl-7">// The new layout of a reservation (only the parts relevant to our example)</span><br/><span class="hl-1">const</span><span class="hl-0"> </span><span class="hl-2">reservationV1_1</span><span class="hl-0">: </span><span class="hl-8">Reservation</span><span class="hl-0"> = {</span><br/><span class="hl-0">  </span><span class="hl-6">version:</span><span class="hl-0"> </span><span class="hl-4">&#39;1.1&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">  </span><span class="hl-6">primary:</span><span class="hl-0"> {</span><br/><span class="hl-0">    </span><span class="hl-6">primaryGuest:</span><span class="hl-0"> {</span><br/><span class="hl-0">      </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wilbur&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Mr.&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">    },</span><br/><span class="hl-0">    </span><span class="hl-6">additionalGuests:</span><span class="hl-0"> [</span><br/><span class="hl-0">      {</span><br/><span class="hl-0">        </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wanda&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Mrs.&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">      },</span><br/><span class="hl-0">      {</span><br/><span class="hl-0">        </span><span class="hl-6">name:</span><span class="hl-0"> </span><span class="hl-4">&#39;Wilma&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">surname:</span><span class="hl-0"> </span><span class="hl-4">&#39;Finkle&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">honorific:</span><span class="hl-0"> </span><span class="hl-4">&#39;Miss&#39;</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">child:</span><span class="hl-0"> </span><span class="hl-1">true</span><span class="hl-0">,</span><br/><span class="hl-0">        </span><span class="hl-6">age:</span><span class="hl-0"> </span><span class="hl-10">12</span><span class="hl-0">,</span><br/><span class="hl-0">      },</span><br/><span class="hl-0">    ],</span><br/><span class="hl-0">    </span><span class="hl-7">// ...</span><br/><span class="hl-0">  },</span><br/><span class="hl-0">  </span><span class="hl-7">// ...</span><br/><span class="hl-0">};</span><br/><br/><span class="hl-6">console</span><span class="hl-0">.</span><span class="hl-3">log</span><span class="hl-0">(</span><span class="hl-3">primaryGuestName</span><span class="hl-0">(</span><span class="hl-6">reservationV1</span><span class="hl-0">));</span><br/><span class="hl-6">console</span><span class="hl-0">.</span><span class="hl-3">log</span><span class="hl-0">(</span><span class="hl-3">primaryGuestName</span><span class="hl-0">(</span><span class="hl-6">reservationV1_1</span><span class="hl-0">));</span>
</code></pre>
...
<ul>
<li><p><strong>prior to v3.0.0</strong> there was a security vulnerability which allowed a developer to perform prototype pollution by sending malformed path segments to <code>json-ptr</code>. If you were one of these developers, you should upgrade to v3.0.0 immediately, and stop using <code>json-ptr</code> to pollute an object&#39;s prototype. If you feel you have a legitimate reason to do so, please use another method and leave <code>json-ptr</code> out of it. Such behavior has been disallowed since it can easily be done using plain ol javascript by those determined to violate common best practice.</p>
</li>
<li><p><strong>prior to v2.1.0</strong> there was a security vulnerability which allowed an unscrupulous actor to execute arbitrary code if developers failed to sanitize user input before sending it to <code>json-ptr</code>. If your code does not sanitize user input before sending it to <code>json-ptr</code>, your project is vulnerable and you should upgrade to v3.0.0 immediately. And while your at it, start sanitized user input before sending it to any library!</p>
</li>
</ul>
...
<ul>
<li><p>2021-10-26 — <strong>3.0.0</strong> <strong>Potential Security Vulnerability Patched</strong></p>
<ul>
<li>When setting a value on an object graph, a developer could purposely use <code>json-ptr</code> to pollute an object&#39;s prototype by passing invalid path segments to the set/unset operations. This behavior has been disallowed.</li>
</ul>
</li>
