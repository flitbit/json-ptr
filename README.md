# json-ptr [![Build Status](https://travis-ci.org/flitbit/json-ptr.png)](http://travis-ci.org/flitbit/json-ptr)&nbsp;[![bitHound Overall Score](https://www.bithound.io/github/flitbit/json-ptr/badges/score.svg)](https://www.bithound.io/github/flitbit/json-ptr)&nbsp;[![NPM](https://nodei.co/npm/json-ptr.png)](https://npmjs.org/package/json-ptr)
